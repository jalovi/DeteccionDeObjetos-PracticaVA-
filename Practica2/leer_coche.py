...
if __name__ == "__main__":
    ...
    # convertirMat(EtiquetasE)
    # matrix_data = np.float32(EtiquetasE)
    # matrix_resp = np.matrix(EtiquetasE).astype('float32')
    # retval = cv2.ml.TrainData_create(CR, cv2.ml.ROW_SAMPLE, matrix_data)